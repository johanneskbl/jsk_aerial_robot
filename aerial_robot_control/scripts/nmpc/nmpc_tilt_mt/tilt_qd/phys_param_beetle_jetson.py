...
try:
    physical_param_path = os.path.join(rospack.get_path("beetle_omni"), "config", "PhysParamBeetleOmniJetson.yaml")
    ...
    physical_param_path = os.path.join(project_root, "robots/beetle_omni/config/PhysParamBeetleOmniJetson.yaml")
