                                             ...
                                             double ctrl_loop_du)
{
  ...
  tmr_record_ = nh_.createTimer(ros::Duration(0.05), &TiltMtNominalServoMPC::callbackRecord, this);
 ...
 */
void nmpc::TiltMtNominalServoMPC::callbackRecord(const ros::TimerEvent& event)
{
  int& NN = mpc_solver_ptr_->NN_;
  int& NX = mpc_solver_ptr_->NX_;
