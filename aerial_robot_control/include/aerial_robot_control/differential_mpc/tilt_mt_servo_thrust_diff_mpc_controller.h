...
class TiltMtServoThrustDiffMPC : public nmpc::TiltMtServoNMPC
{
public:
...
protected:
  double thrust_ctrl_vel_min_;
  double thrust_ctrl_vel_max_;
  double servo_angle_vel_min_;
  double servo_angle_vel_max_;
